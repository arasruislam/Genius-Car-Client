      ...
      <section className="mb-32 pt-12">
        <div className="flex flex-col-reverse md:flex-col lg:flex-row items-center gap-12 p-2">
          ...
          <div className="flex-1 sm:w-full md:w-9/12 lg:w-full relative">
            <img
              src={person}
              className="rounded-lg h-[473px] w-[470px] object-cover"
              alt="About Section Image"
            />
            <img
              src={parts}
              className="absolute -bottom-20 shadow right-0 h-[332px] w-[327px] object-cover rounded-xl border-8 border-white"
              alt="About Section Image"
            />
          </div>
          {/* Content Section */}
